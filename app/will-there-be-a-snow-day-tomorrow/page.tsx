...
export const metadata: Metadata = {
  title: "Will There Be a Snow Day Tomorrow? – By City",
  description: "Find out if there will be a snow day tomorrow in your city. Check predictions for 200+ US and Canadian cities.",
  alternates: { canonical: "https://snowday-calc.com/will-there-be-a-snow-day-tomorrow" },
}

export default function WillThereBeIndexPage() {
        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-10">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Select your city and find out the probability of a school closure tomorrow due to snow or winter weather.
            </p>
          </div>
          {letters.map((letter) => (
            <div key={letter} className="mb-8">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-2">
                {grouped[letter].map((city) => (
                  <Link
                    key={city.slug}
                    href={`/will-there-be-a-snow-day-tomorrow/${city.slug}`}
